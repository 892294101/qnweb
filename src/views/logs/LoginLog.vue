<template>
  <el-card body-style="padding:15px; margin-top:5px;">
    <el-form size="small" :model="queryParams" :inline="true">
      <el-form-item prop="username" label="用户名称">
        <el-input v-model="queryParams.username" placeholder="请输入用户名称" clearable
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item prop="loginStatus" label="登录状态">
        <el-select class="searchList" size="small" placeholder="请选择岗位状态" v-model="queryParams.loginStatus" clearable>
      ...
      <el-form-item prop="beginTime" label="开始时间">
        <el-date-picker id="beginTime"
                        class="input-width" v-model="queryParams.beginTime"  type="date"
                         value-format="yyyy-MM-dd" clearable placeholder="请选择开始时间"
                        @keyup.enter.native="handleQuery"></el-date-picker>
      </el-form-item>
      <el-form-item prop="endTime" label="结束时间">
        <el-date-picker id="endTime"
                        class="input-width" v-model="queryParams.endTime"   type="date"
                         value-format="yyyy-MM-dd" clearable placeholder="请选择结束时间"
                        @keyup.enter.native="handleQuery"></el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-card body-style="padding:15px; margin-top:5px;">
      <div style="display: none" v-permission="PermCodeAddHost">
        <el-row :gutter="10" class="mb8" style="margin-bottom: 15px;">
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" size="small" :disabled="multiple" @click="batchHandleDelete">删除</el-button>
          </el-col>
          <el-col :span="1.5">
      ...
      <el-form :inline="true">
        <el-table size="small" v-loading="Loading" :data="sysLoginInfoList" border stripe style="width: 100%"
